...
public class Todocompletedshowadapter extends ArrayAdapter {
    ArrayList<TodoTaskModel> todoTaskModelArrayList=new ArrayList<>();

    public Todocompletedshowadapter(@NonNull Context context, int resource, ArrayList<TodoTaskModel> todoTaskModelArrayList) {
